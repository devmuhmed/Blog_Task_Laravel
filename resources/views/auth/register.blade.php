            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="phone" name="phone" id="phone" placeholder="your phone"
                        class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('phone') border-red-500 @enderror"
                        value="{{ old('phone') }}">
                    @error('phone')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"
                        placeholder="password again" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="">
                </div>
                <div>
                    <button type="submit"
